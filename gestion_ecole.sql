...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1721346239ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_ecole&table=parent">`gestion_ecole`.`parent`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="36494c7a5d21434b614263777461593b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="gestion_ecole" targettable="user">
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_ecole`.`user` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(100) NOT NULL ,  `email` VARCHAR(100) NOT NULL ,  `password` VARCHAR(100) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="gestion_ecole" targettable="teacher">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_ecole`.`teacher` ( `id` INT NOT NULL AUTO_INCREMENT ,  `full_name` VARCHAR(255) NOT NULL ,  `matricule` VARCHAR(255) NOT NULL ,  `Matiere` VARCHAR(255) NOT NULL ,  `phone` VARCHAR(255) NOT NULL ,  `gender` VARCHAR(255) NOT NULL ,  `classe` VARCHAR(255) NOT NULL ,  `id_classe` INT NOT NULL ,    PRIMARY KEY  (`id`),    UNIQUE  `classe` (`id_classe`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="gestion_ecole" targettable="classe">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_ecole`.`classe` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(255) NOT NULL ,  `id_teacher` INT NOT NULL ,    PRIMARY KEY  (`id`),    UNIQUE  `teacher` (`id_teacher`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `teacher`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_ecole" targettable="teacher">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `classe`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_ecole" targettable="teacher">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `teacher`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="gestion_ecole" targettable="student">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_ecole`.`student` ( `id` INT NOT NULL AUTO_INCREMENT ,  `matricule` VARCHAR(255) NOT NULL ,  `full name` VARCHAR(255) NOT NULL ,  `phone` VARCHAR(255) NOT NULL ,  `class` VARCHAR(255) NOT NULL ,  `parents` VARCHAR(255) NOT NULL ,  `adresse` VARCHAR(255) NOT NULL ,  `date de naissance` DATE NOT NULL ,  `email` VARCHAR(255) NOT NULL ,  `id teacher` INT NOT NULL ,    PRIMARY KEY  (`id`),    UNIQUE  `teacher` (`id teacher`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="gestion_ecole" targettable="parent">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `gestion_ecole`.`parent` ( `id` INT NOT NULL AUTO_INCREMENT ,  `matricule` VARCHAR(255) NOT NULL ,  `full name` VARCHAR(255) NOT NULL ,  `job` VARCHAR(255) NOT NULL ,  `phone` VARCHAR(255) NOT NULL ,  `gender` VARCHAR(255) NOT NULL ,  `adresse` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_ecole" targettable="parent">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `parent`</span>
                        </div>
...
<p>index.php: Paramètre absent : what<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br>index.php: Paramètre absent : export_type<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br></p>
  ...
  <div class="clearfloat" id="pma_errors">
    <div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture de structure pour la table gestion_ecole.classe : #1932 - Table &amp;#039;gestion_ecole.classe&amp;#039; doesn&amp;#039;t exist in engine</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture des données pour la table gestion_ecole.classe : #1064 - Erreur de syntaxe près de &amp;#039;FROM `gestion_ecole`.`classe`&amp;#039; à la ligne 1</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture de structure pour la table gestion_ecole.student : #1932 - Table &amp;#039;gestion_ecole.student&amp;#039; doesn&amp;#039;t exist in engine</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture des données pour la table gestion_ecole.student : #1064 - Erreur de syntaxe près de &amp;#039;FROM `gestion_ecole`.`student`&amp;#039; à la ligne 1</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture de structure pour la table gestion_ecole.teacher : #1932 - Table &amp;#039;gestion_ecole.teacher&amp;#039; doesn&amp;#039;t exist in engine</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture des données pour la table gestion_ecole.teacher : #1064 - Erreur de syntaxe près de &amp;#039;FROM `gestion_ecole`.`teacher`&amp;#039; à la ligne 1</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture de structure pour la table gestion_ecole.user : #1932 - Table &amp;#039;gestion_ecole.user&amp;#039; doesn&amp;#039;t exist in engine</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Erreur de lecture des données pour la table gestion_ecole.user : #1064 - Erreur de syntaxe près de &amp;#039;FROM `gestion_ecole`.`user`&amp;#039; à la ligne 1</div>
  </div>
